		...
		switch(m_geometryMode) {
			...
			case HOLE:
				...
				vec.setZ(!((i > m_grid/3 && j > m_grid/3) &&
				           (i < m_grid*2/3 && j < m_grid*2/3)) ? 0.5f : 0.0f);
				break;
			case DIAGONALWALL:
				// PUT YOUR CODE HERE
				vec.setZ((((m_grid-i)-j < 3) && ((m_grid-i)-j > 0)) ? 0.25f : 0.0f);
				break;
			case SIDEWALL:
				// PUT YOUR CODE HERE
			...
			case DIAGONALBLOCK:
				// PUT YOUR CODE HERE
				vec.setZ(((m_grid-i)-j < 3) ? 0.25f : 0.0f);
				break;
			case MIDDLEBLOCK:
				// PUT YOUR CODE HERE
				vec.setZ(((i > m_grid/3 && j > m_grid/3) &&
			...
			case HILL:
				...
				vec.setZ((sin(M_PI * ((float)i/(float)m_grid)) +
				          sin(M_PI * ((float)j/(float)m_grid))) / 3.0f);
				break;
			case HILLFOUR:
				// PUT YOUR CODE HERE
				vec.setZ((sin(M_PI*2.0f * ((float)i/(float)m_grid)) +
				          sin(M_PI*2.0f * ((float)j/(float)m_grid))) / 3.0f);
				break;
		}
	   }
	}
